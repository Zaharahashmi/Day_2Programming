public class ConstructorExample {
    ...
    public ConstructorExample(int defaultValue) {
        System.out.println("\nDefault constructor called with default value: " + defaultValue);
    }
    public ConstructorExample(String strParam) {
        System.out.println("\nParameterized constructor called with String parameter: " + strParam);
    }
    public ConstructorExample(int intParam1, int intParam2) {
        System.out.println("\nParameterized constructor called with two int parameters: " + intParam1 + ", " + intParam2);
    }
